...
class MoistureSoilSensor:
    ...
    def __init__(self, ms_sensor_pin, min_value=260, max_value=520):
        ...
        :param min_value: Il valore minimo di umidità (valore ADC corrispondente a terreno completamente bagnato).
        :param max_value: Il valore massimo di umidità (valore ADC corrispondente a terreno completamente secco).
        """
    ...
    def read_moisture_value(self):
        ...
        # Calcolo della percentuale di umidità invertita
